...
:synopsis: Converter of mzML into a text format accessible from pyspark

.. moduleauthors:: Vitaly Kovalev <intscorpio@gmail.com>, Ivan Protsyuk <iprotsyuk@gmail.com>
"""
...
class MzmlTxtConverter(object):
    ...
    """
    def __init__(self, mzml_path, txt_path, coord_path=None):
    ...
    def convert(self, preprocess=False, print_progress=True):
        ...
        if not exists(self.txt_path):
            ...
            self.parser = SimpleMzmlParser(self.mzml_path)
